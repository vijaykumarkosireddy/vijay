export const SITE_CONTENT = {
  ...
  HERO: {
    ...
    SUBTITLE:
      "Preserving the soulful tradition of Carnatic Music & Masterfully crafting stories through Pencil Sketches.",
    IMAGE: "/vijay-2.png",
  },

  BIO: {
    SUMMARY:
      "A dedicated Carnatic music professional and professional pencil sketch artist based in Visakhapatnam. Preserving traditional arts through music and realistic graphite sketches.",
    EXTENDED:
      "With decades of experience in Carnatic music and a passion for fine arts, Vijay Kumar Kosireddy brings a unique blend of sound and vision to his audience.",
    SECONDARY_IMAGE: "/vijay.png",
  },

  CONTACT: {
    PHONES: process.env.NEXT_PUBLIC_PHONES?.split(",") || ["+91 9700346808", "+91 9123456789"],
    EMAILS: process.env.NEXT_PUBLIC_EMAILS?.split(",") || [
