...
import { AdminHeader, AdminTabs, FormsContainer, DatabaseExplorer, SitemapManager } from "@/components/admin"
      ...
      <div className="space-y-12">
        {activeTab === "tools" ? (
          <div className="space-y-8">
            ...
            {/* Sitemap Manager */}
            <SitemapManager onSuccess={(msg) => addToast("success", msg)} onError={(msg) => addToast("error", msg)} />
          </div>
        ) : activeTab === "blogs" ? (
          blogPreviewMode ? (
            <BlogPreview
