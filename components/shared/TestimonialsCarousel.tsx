...
async function getTestimonialsFromAPI() {
    ...
    >
      ...
      <div className="glass p-10 md:p-16 rounded-[2.5rem] border-white/5 transition-all bg-white/[0.02] min-h-[400px] flex flex-col justify-between">
        <div className="space-y-8">
          ...
          <p className="text-lg md:text-2xl text-white/70 font-light leading-relaxed italic min-h-[4rem] flex items-center">
        ...
        <div className="mt-12 flex items-center justify-between pt-8 border-t border-white/5">
          <div className="flex items-center gap-5">
            {currentTestimonial.imageUrl ? (
              ...
              <div className="h-14 w-14 rounded-2xl border border-gold/20 bg-gold/10 flex items-center justify-center shadow-xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
